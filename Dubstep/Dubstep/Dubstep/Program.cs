...
// and he often uses dubstep music in his performance.Recently, he has decided to take a couple of old songs and make dubstep remixes from them.
...
//but since he isn't into modern music, he decided to find out what was the initial song that Polycarpus remixed. Help Jonny restore the original song.
    ...
    class Program
    {
        ...
        public class Dubstep
        {
            public static string SongDecoder(string input)
            {
                ...
                splitedArr = splitedArr.Where(e => e.Length != 0).ToArray();
